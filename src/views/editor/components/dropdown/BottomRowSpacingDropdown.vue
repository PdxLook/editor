...
<template>
  <div ref="bottomRowSpacingDropdownRef" class="dropdown dropdown-bottomRowSpacing">
    ...
    <div class="dropdown-menu">
      <div v-for="spacing in SPACING_LIST" :key="spacing" class="menu-item"
        :class="{ active: currentSpacing === spacing }" @click="handleSetSpacing(spacing)">
