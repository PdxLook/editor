...
const handleInsertEmoji = (index) => {
  const emojiHTML = `
    <img
      src="https://res.wx.qq.com/t/wx_fed/we-emoji/res/v1.3.10/assets/Expression/Expression_${+index + 1
    }@2x.png"
  ...
  <div ref="emojiDropdownRef" class="dropdown dropdown-emoji">
    ...
    <div class="dropdown-menu">
      <div class="emoji-list">
        <div v-for="i in 105" :key="i" class="emoji-item" @click="handleInsertEmoji(i)">
          <div class="icon-emoji" :style="{ backgroundPositionY: `${-100 * i}%` }"></div>
        </div>
      </div>
    </div>
  </div>
