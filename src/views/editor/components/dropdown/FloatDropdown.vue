...
<template>
  <div ref="floatDropdownRef" class="dropdown dropdown-float">
    <button class="dropdown-toggle">
      <svg-icon :name="['default', 'left'].includes(currentFloat)
        ? 'floatLeft'
        : 'floatRight'
        "></svg-icon>
    ...
    <div class="dropdown-menu">
      <div class="menu-item" :class="{ active: currentFloat === 'default' }" @click="handleSetFloat('default')">
        <svg-icon name="floatLeft"></svg-icon>默认
      </div>
      <div class="menu-item" :class="{ active: currentFloat === 'left' }" @click="handleSetFloat('left')">
        <svg-icon name="floatLeft"></svg-icon>左浮动
      </div>
      <div class="menu-item" :class="{ active: currentFloat === 'right' }" @click="handleSetFloat('right')">
