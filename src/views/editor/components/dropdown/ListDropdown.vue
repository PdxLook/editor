...
<template>
  <div ref="listDropdownRef" class="dropdown dropdown-list">
    ...
    <div class="dropdown-menu" @click="handleFormatList($event)">
      <div class="menu-item" data-list-type="bulletList" data-list-style-type="circle">
        ○ 大圆圈
      </div>
      <div class="menu-item" data-list-type="bulletList" data-list-style-type="disc">
        ● 小黑点
      </div>
      <div class="menu-item" data-list-type="bulletList" data-list-style-type="square">
        ■ 小方块
      </div>
      <div class="menu-item" data-list-type="orderedList" data-list-style-type="decimal">
        1,2,3...
      </div>
      <div class="menu-item" data-list-type="orderedList" data-list-style-type="lower-alpha">
        a,b,c...
      </div>
      <div class="menu-item" data-list-type="orderedList" data-list-style-type="lower-roman">
        i,ii,iii...
      </div>
      <div class="menu-item" data-list-type="orderedList" data-list-style-type="upper-alpha">
        A,B,C...
      </div>
      <div class="menu-item" data-list-type="orderedList" data-list-style-type="upper-roman">
        I,II,III...
      </div>
    </div>
  </div>
